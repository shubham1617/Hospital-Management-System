...
@AllArgsConstructor
@Builder
@Schema(description = "Doctor Data Transfer Object for API responses")
public class DoctorDTO {

    @Schema(description = "Unique doctor ID", example = "DOC001")
    ...
    @Builder.Default
    @Schema(description = "Is the doctor currently active", example = "true")
